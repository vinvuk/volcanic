        ...
        <div className="flex items-center gap-3 pointer-events-auto">
          ...
          <div className="relative">
            <button
              ...
              aria-label="Filter volcanoes by status"
            ...
            <AnimatePresence>
              {showFilters && (
                <motion.div
                  ...
                  role="menu"
                  aria-label="Filter by volcano status"
                >
                  {statusOrder.map((status) => {
                    ...
                    return (
                      <button
                        ...
                        aria-label={`${isVisible ? "Hide" : "Show"} ${config.label} volcanoes`}
                      >
                        <div
          ...
          {/* Time with timezone */}
          <div
            className="glass-panel rounded-2xl px-4 py-2.5 flex items-center gap-2"
